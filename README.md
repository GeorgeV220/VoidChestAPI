...
This API won't work for VoidChest versions bellow 5.4.0
...
dependencies {
    compileOnly "com.georgev22.voidchest:voidchestapi:5.4.0"
}
```
...
written to `build/libs/voidchestapi-5.4.0.jar`.
