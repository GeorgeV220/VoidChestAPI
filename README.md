...
This API won't work for VoidChest versions bellow 5.5.0-beta.1
...
dependencies {
    compileOnly "com.georgev22.voidchest:voidchestapi:5.5.0-beta.1"
}
```
...
written to `build/libs/voidchestapi-5.5.0-beta.1.jar`.
