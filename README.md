...
This API won't work for VoidChest versions bellow 6.0.0-beta.1
...
dependencies {
    compileOnly "com.georgev22.voidchest:voidchestapi:6.0.0-beta.1"
}
```
...
written to `build/libs/voidchestapi-6.0.0-beta.1`.
