...
public class ASMEventExecutorGenerator {
    ...
    private static final String EXECUTE_DESCRIPTOR =
            "(Lcom/georgev22/voidchest/api/event/interfaces/EventListener;Lcom/georgev22/voidchest/api/event/Event;)V";
    ...
    public static byte @NotNull [] generateEventExecutor(@NotNull Method m, @NotNull String name) {
        ...
        methodGenerator.visitMethodInsn(m.getDeclaringClass().isInterface()
                ? INVOKEINTERFACE
                : INVOKEVIRTUAL, Type.getInternalName(m.getDeclaringClass()), m.getName(), Type.getMethodDescriptor(m), m.getDeclaringClass().isInterface());
    ...
    public static String generateName() {
        ...
        return "com.georgev22.voidchest.api.event.asm.generated.GeneratedEventExecutor" + id;
    }
}
