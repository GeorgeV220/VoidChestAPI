...
/**
 * The PlayerDataDeleteEvent class is an event that is fired when a PlayerData is deleted.
 */
public class PlayerDataDeleteEvent extends PlayerEvent {
    private static final HandlerList HANDLERS = new HandlerList();

    /**
     * Constructs a new PlayerDataDeleteEvent with the specified PlayerData.
     *
     * @param playerData The playerData associated with the PlayerData.
     */
    public PlayerDataDeleteEvent(AbstractPlayerData playerData) {
        super(playerData);
    }
